...
public class Browser extends loginPage{
    ...
    public static WebDriver launchChrome(){
        System.setProperty("webdriver.chrome.driver","C:\\Users\\lenovo\\OneDrive\\Documents\\Chromedriver\\ChromeDrivers\\chromedriver146.exe");
    ...
    public static WebDriver launchMsEdge(){
        System.setProperty("webdriver.msedge.driver","C:\\Users\\lenovo\\OneDrive\\Documents\\Chromedriver\\msEdgeDrivers\\msedgedriver147.exe");
        WebDriver driver = new FirefoxDriver();
        page = new loginPage(driver);
        return driver;
    }
